-- http://haskell.org/haskellwiki/index.php?title=Xmonad/Config_archive/Thayer_Williams%27_xmonad.hs
--
...
myDzenPP  = dzenPP
    ...
    , ppSep     = "     "
    , ppLayout  = dzenColor "#aaaaaa" "" . wrap "^ca(1,xdotool key super+space)Â· " " Â·^ca()"
