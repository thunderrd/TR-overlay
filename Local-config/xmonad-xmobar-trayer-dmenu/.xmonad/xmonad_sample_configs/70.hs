-- http://haskell.org/haskellwiki/index.php?title=Xmonad/Config_archive/iderrick_xmonad.hs
--
...
--    [ className =? "MPlayer"        --> doFloat
    ...
    , className =? "Navigator"      --> doF (W.shift "4")
    , className =? "Uzbl"           --> doF (W.shift "4")
