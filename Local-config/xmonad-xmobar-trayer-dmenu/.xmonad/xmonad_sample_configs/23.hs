-- http://haskell.org/haskellwiki/index.php?title=Xmonad/Config_archive/hgabreu%27s_xmonad.hs
...
--I commented at mrt line 150: {-draggerWrs ++-}
        ...
        skype = Title "<myuser> - Skypeâ¢ (Beta)" `Or` Title "Skypeâ¢ 2.1 (Beta) for Linux"
